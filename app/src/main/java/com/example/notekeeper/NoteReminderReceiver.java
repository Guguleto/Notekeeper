...
public class NoteReminderReceiver extends BroadcastReceiver {
    public static final String EXTRA_NOTE_TITLE = "com.example.notekeeper.extras.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.example.notekeeper.extras.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID = "com.example.notekeeper.extras.NOTE_ID";
